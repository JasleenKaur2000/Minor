      ...
      <div style={{ display: "flex", justifyContent: "center" }}>
        ...
        >
          <form className="gec-info-form">
            <TextField name="title" label=" Gec subject name" />

            <TextField name="title" label=" Subject Code " />

            <TextField name="title" label="Department " />
            <TextField name="title" label="Submit pdf" />
