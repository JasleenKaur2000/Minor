...
exports.signup = async (req, res, next) => {
  try {
    ...
    const { userId, userEmail, password, department, admissionYear, program, role, type } = req.body
    const hashedPassword = await hashPassword(password);
    const tempobject = { userId: userId, userEmail: userEmail, password: hashedPassword, role: role || "student", department: department, admissionYear: admissionYear, program: program, type: type }
